...
from pathlib import Path  # 添加 pathlib 模块
...
class Level:
	...
	def create_map(self):
		# 使用 pathlib 处理路径
		map_path = Path(__file__).parent.parent / "map"
		graphics_path = Path(__file__).parent.parent / "graphics"
...
class YSortCameraGroup(pygame.sprite.Group):
	def __init__(self):
		...
		# creating the floor
		graphics_path = Path(__file__).parent.parent / "graphics" / "tilemap"
		self.floor_surf = pygame.image.load(str(graphics_path / "ground.png")).convert()
